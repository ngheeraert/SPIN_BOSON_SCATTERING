...
npadd=20        # npadd: Number of additional coherent components to add during time evolution (adaptive basis).
p0=0.000005     # p0: Initial amplitude assigned to newly-added coherent components (-p0).
...
tmax=1500       # tmax: Final simulation time.
nmode=1200      # nmode: Number of discretised bosonic modes used to approximate the continuum.
...
x0=-700         # x0: Initial centre position of the incident wavepacket
xmin=400        # xmin: Spatial cutoff used when computing Fourier transforms / field profiles
nval=0.5        # nval: Average photon number / pulse intensity parameter used for coherent-state input (-n).
tref=3          # tref: Reference time used in the adaptive polaron-adding schedule (-tref).
me=0.0000001    # me: Same as merr
kmin=0.06025
kmax=0.20
kint=0.001
